                    ...
                    <div class="col-lg-3 d-flex justify-content-center border border-1 shadow"
                        ...
                        <div class="d-flex flex-column flex-shrink-0 p-3" style="width: 280px;">
                            ...
                            <ul class="nav nav-pills flex-column mb-auto">
                                ...
                                <li>
                                    <a href="hotel.php" class="nav-link link-dark border border-1 my-1">
                                        <svg class="bi me-2" width="16" height="16">
                                ...
                                <li>
                                    <a href="Inclusion.php" class="nav-link link-dark border border-1 my-1">
                                        <svg class="bi me-2" width="16" height="16">
                                            <use xlink:href="#people-circle"></use>
                                        </svg>
                                        Inclusions
                                ...
                                <li>
                                    <a href="Tag_Destination.php" class="nav-link link-dark border border-1 my-1">
                                        <svg class="bi me-2" width="16" height="16">
                                            <use xlink:href="#people-circle"></use>
                                        </svg>
                                        Tag Destination
                                ...
                                <li>
                                    <a href="PDF.php" class="nav-link link-dark border border-1 my-1">
                                        <svg class="bi me-2" width="16" height="16">
                                            <use xlink:href="#people-circle"></use>
                                        </svg>
                                        PDF
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h1 class="modal-title fs-5" id="exampleModalLabel">Gallary Add
                                                        </h1>
